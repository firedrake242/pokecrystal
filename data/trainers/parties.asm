...
MortyGroup:
	...
	db 23, HAUNTER,    WILLOWISP, MEAN_LOOK, HEX, NIGHT_SHADE
	db -1 ; end
...
BrockGroup:
	...
	db 41, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HYPER_BEAM
...
LassGroup:
	...
	db 18, PSYDUCK,    TACKLE, TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end
	...
	db 21, PSYDUCK,    TACKLE, TAIL_WHIP, DISABLE, CONFUSION
	db -1 ; end

	; LASS (15)
	db "DANA@", TRAINERTYPE_MOVES
	db 29, PSYDUCK,    TACKLE, DISABLE, CONFUSION, SCREECH
	db 29, AMPHAROS,   TACKLE, THUNDERSHOCK, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PSYDUCK,    TACKLE, DISABLE, CONFUSION, SCREECH
...
CooltrainerMGroup:
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, HYPER_BEAM, PROTECT
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, HYPER_BEAM, BLIZZARD
	...
	db 32, KINGLER,    BUBBLEBEAM, STOMP, PROTECT, HYPER_BEAM
...
FisherGroup:
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 38, REMORAID,   PSYBEAM, AURORA_BEAM, SCALD, HYPER_BEAM
	db -1 ; end
...
SwimmerFGroup:
	...
	db 20, PSYDUCK,    TACKLE, TAIL_WHIP, DISABLE, CONFUSION
...
SailorGroup:
	...
	db 18, KRABBY,     SCALD, LEER, VICEGRIP, HARDEN
...
Rival2Group:
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, HEX, WILLOWISP
