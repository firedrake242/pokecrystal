...
MapGroup_NewBark:
	...
	map Route26_Fall, TILESET_JOHTO, ROUTE_FALL,LANDMARK_ROUTE_26, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route27_Fall, TILESET_JOHTO, ROUTE_FALL,LANDMARK_ROUTE_27, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route29_Fall, TILESET_JOHTO, ROUTE_FALL,LANDMARK_ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown_Fall, TILESET_JOHTO, TOWN_FALL, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route26_Winter, TILESET_JOHTO, ROUTE_WINTER,LANDMARK_ROUTE_26, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route27_Winter, TILESET_JOHTO, ROUTE_WINTER,LANDMARK_ROUTE_27, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route29_Winter, TILESET_JOHTO, ROUTE_WINTER,LANDMARK_ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown_Winter, TILESET_JOHTO, TOWN_WINTER, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
