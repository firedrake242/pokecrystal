...
MapGroup_NewBark:
	...
	map NewBarkTownFall, TILESET_JOHTO, TOWN_FALL, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map NewBarkTownWinter, TILESET_JOHTO, TOWN_WINTER, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
