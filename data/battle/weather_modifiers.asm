WeatherTypeModifiers:
	...
	db WEATHER_ECLIPSE, FAIRY, MORE_EFFECTIVE
	db WEATHER_ECLIPSE, GHOST, MORE_EFFECTIVE
	db WEATHER_ECLIPSE, DARK, MORE_EFFECTIVE
	db -1 ; end

WeatherMoveModifiers:
	db WEATHER_RAIN, EFFECT_SOLARBEAM, NOT_VERY_EFFECTIVE
	db WEATHER_HAIL, EFFECT_SOLARBEAM, NOT_VERY_EFFECTIVE
	db WEATHER_ECLIPSE, EFFECT_SOLARBEAM,NOT_VERY_EFFECTIVE
	db -1 ; end
